<div align="center">
  <h1>Awesome-Design-List</h1>

  <p>:heart: 收藏列表 - :+1: 很棒的设计资源。</p>
  <p><i>Favorites list - great design resources.</i></p>
</div>
...
- [在线资源（Online Resources）](#在线资源)
  ...
  - [素材资源（Material Resources）](#素材资源)
- [设计软件（Design Software）](#设计软件)
...
_Software interface design, prototype drawing design, etc._
...
- 图形设计（Graphics）
  ...
  - [Inkscape](https://inkscape.org/) - 绘图工具，**免费软件**。
